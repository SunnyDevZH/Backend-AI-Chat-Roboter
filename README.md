...
1. Klonen Sie das Repository:
   ```bash
   git clone https://github.com/SunnyDevZH/Backend-AI-Chat-Roboter
   ```
...
4. Starten Sie den Flask-Server lokal:
   ```bash
   python app.py
   ```

5. Der Server wird standardmäßig unter `http://127.0.0.1:5000` ausgeführt. Sie können die Endpunkte mit einem Tool wie Postman oder cURL testen.
